...
if __name__ == "__main__":
    ...
    parameter_variation(agreements, "agreement", "agreement", base_config)
    parameter_variation(noise, "noise", "noise", base_config)
    parameter_variation(density, "density",
                        "density", base_config, logx=True)
    parameter_variation(minimum_cluster_distances,
                        "min_cluster_dist", "min_cluster_dist", base_config)
    parameter_variation(noise, "noise", "noise", base_config)
    parameter_variation(stds, "std", "std", base_config)
    parameter_variation(dimensions,
                        "dimension", "dimension", base_config)
    parameter_variation(n_components, "n_components",
                        "n_components", base_config)
